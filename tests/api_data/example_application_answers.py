...
test_application_answers = {
    ...
    "project-information": {
        ...
        "Explain why the asset is at risk of being lost to the community, or why it has already been lost": "Test",
        "Give a brief summary of your project, including what you hope to achieve": "Test",
        "Address of the community asset": "Test Address, null, Test Town Or City, null, QQ12QQ",
    ...
    "organisation-information": {
        ...
        "Organisation address": "Test Address, null, Test Town Or City, null, QQ12QQ",
    ...
    "applicant-information": {
        ...
        "Lead contact email address": "testemailfundingservice@testemailfundingservice.com",
    ...
    "asset-information": {
        ...
        "Describe the expected sale process, or the proposed terms of your lease if you are renting the asset": "Test",
        ...
        "Why is the asset at risk of closure?": ["for-sale-or-listed-for-disposal"],
    },
    ...
    "community-benefits": {
        ...
        "Explain how you plan to sustain, and potentially expand, these benefits over time": "Test",
        "Tell us how you'll make sure the whole community benefits from the asset": "Test",
    },
    "inclusiveness-and-integration": {
        "Describe the planned activities or services that will take place at the asset": "Test",
        "Describe anything that might prevent people from using the asset or participating in its running": "Test",
        "Tell us how you'll make your project accessible and inclusive to everyone in the community": "Test",
        "Describe how the project will bring people together from all over the community": "Test",
    },
    "project-costs": {
    ...
    "community-representation": {
        ...
        "Explain how you'll consider the views of the community in the running of the asset": "Test",
    },
    "value-to-the-community": {
        "Tell us about your local community as a whole": "Test",
        "Describe any specific challenges your community faces, and how the asset will address these": "Test",
    },
    "declarations": {
