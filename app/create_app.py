...
from app.assess.views.filters import status_to_human, remove_theme_name_score
...
def create_app() -> Flask:
    ...
    flask_app.jinja_env.filters["remove_theme_name_score"] = remove_theme_name_score
